...
public:
    ...
    void detectLevel (float input, float& output, float fs) {
        b0_a = 1-exp(-1.0 / (0.001 * fs)); // 1 ms attack time
        b0_r = 1-exp(-1.0 / (0.1 * fs)); // 100 ms release time
